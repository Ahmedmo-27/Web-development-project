document.addEventListener("DOMContentLoaded", function () {
  ...
  const navigationLinks = document.querySelectorAll(
    "#header-bottom .navigation .extension"
  );
  const headerExtension = document.getElementById(
  ...
  /*const brandsLink = document.querySelector('a[data-category="Brands"]');
    const brandsExtension = document.getElementById('header-bottom-brands-extension');
    const exitBrandsButton = document.getElementById('exit-brands-extension-button');
    let mouseOverBrandsLink = false;
    let mouseOverBrandsExtension = false;

if (brandsLink && brandsExtension) {
    brandsLink.addEventListener('mouseenter', () => {
        mouseOverBrandsLink = true;
        brandsExtension.style.display = 'block';
    });

    brandsLink.addEventListener('mouseleave', () => {
        mouseOverBrandsLink = false;
        setTimeout(() => {
            if (!mouseOverBrandsExtension) {
                brandsExtension.style.display = 'none';
            }
        }, 30);
    });

    brandsExtension.addEventListener('mouseenter', () => {
        mouseOverBrandsExtension = true;
    });

    brandsExtension.addEventListener('mouseleave', () => {
        mouseOverBrandsExtension = false;
        setTimeout(() => {
            if (!mouseOverBrandsLink) {
                brandsExtension.style.display = 'none';
            }
        }, 30);
    });
    ...
    if (exitBrandsButton) {
        exitBrandsButton.addEventListener('click', () => {
            brandsExtension.style.display = 'none';
        });
    }
...
if (exitButton) {
  ...
  const braceletsExtension = document.getElementById(
    "header-bottom-bracelets-extension"
  );
  const exitBraceletsButton = document.getElementById(
    "exit-bracelets-extension-button"
  );
  ...
  document
    .getElementById("exit-search-extension-button")
